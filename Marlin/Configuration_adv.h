...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //enable mary
    ...
    #define POWER_LOSS_PIN         P1_25 //enable mary // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    ...
    //#define POWER_LOSS_MIN_Z_CHANGE 0.05 //disable mary // (mm) Minimum Z change before saving power-loss data
 ...
 */
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only //enable mary
