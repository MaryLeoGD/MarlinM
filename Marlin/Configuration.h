...
#define STRING_CONFIG_H_AUTHOR "(Mary, Ender-3 V1.2)" // Who made the changes.
...
#ifndef MOTHERBOARD
  //#define MOTHERBOARD BOARD_SANGUINOLOLU_12    // Sanguinololu 1.2 and above
   //#define MOTHERBOARD BOARD_MELZI                 // Melzi     write No work
   //#define MOTHERBOARD BOARD_MELZI_V2              // Melzi V2    write No work
   #define MOTHERBOARD BOARD_MELZI_CREALITY        // Melzi Creality3D (for CR-10 etc) No work
    //#define MOTHERBOARD BOARD_MELZI_CREALITY_ENDER2 // Melzi Creality3D (for Ender-2) No work
#endif
...
#define CUSTOM_MACHINE_NAME "Ender-3 V1.2"
