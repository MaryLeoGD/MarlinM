...
#define STRING_CONFIG_H_AUTHOR "(Mary, 21.11.23)" // Mary first changes. //#define STRING_CONFIG_H_AUTHOR "(Pacoca Tech, RJ)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // Mary first changes. SERIAL_PORT 0
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // Mary first changes. SERIAL_PORT -1
...
#define CUSTOM_MACHINE_NAME "Mary Ender 3" // Mary first changes  // #define CUSTOM_MACHINE_NAME "PacocaTech"
 ...
 */
#define X_DRIVER_TYPE  TMC2209  // Mary first changes // TMC2208
#define Y_DRIVER_TYPE  TMC2209  // Mary first changes // TMC2208
#define Z_DRIVER_TYPE  TMC2209  // Mary first changes // TMC2208
...
#define E0_DRIVER_TYPE TMC2209  // Mary first changes // TMC2208
 ...
 */
#define PSU_CONTROL  // Mary PSU changes  enable//
#define PSU_NAME "Power Supply" // Mary PSU changes //

#if ENABLED(PSU_CONTROL)
  //#define MKS_PWC                 // Using the MKS PWC add-on
  //#define PS_OFF_CONFIRM          // Confirm dialog when power off
  //#define PS_OFF_SOUND            // Beep 1s when power off
  #define PSU_ACTIVE_STATE HIGH     // Mary PSU changes // // Set 'LOW' for ATX, 'HIGH' for X-Box
...
//#define TEMP_SENSOR_0 -5  //1 to -5  Mary Max 31865 changes 
...
#define ENDSTOPPULLUPS
  ...
  //#define ENDSTOPPULLUP_ZMIN_PROBE  // Mary first changes // enable
#endif
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Mary first changes //
 ...
 */
//#define BLTOUCH // Mary first changes //
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { -42, -5, 0 } // Mary first changes //
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }  // Mary first changes //
...
//#define PROBING_MARGIN 30 // Mary first changes //
#define PROBING_MARGIN 10  // Mary first changes //
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z // Mary first changes //
...
//#define AUTO_BED_LEVELING_BILINEAR   // Mary first changes //
 ...
 */
//#define Z_SAFE_HOMING  // Mary first changes //
